...
phone.addEventListener('keyup', (e)=>{
    ...
    e.target.value == e.target.value.replace(/\D/g,'') ? onValidation(message, '', 1) : onValidation(message, '*Please enter valid number', 0) // regular expression (/\D/g) to remove all non-digit characters from the input. 
})
